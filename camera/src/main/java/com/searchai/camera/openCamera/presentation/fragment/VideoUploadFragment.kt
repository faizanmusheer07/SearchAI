...
import com.searchai.camera.databinding.DialogeForCameraFragmentBinding
import com.searchai.camera.databinding.FragmentVideoUploadBinding
import com.searchai.common.kotlinExtentions.BaseFragment
...
import com.searchai.common.navigation.ToFlowNavigable
...
@AndroidEntryPoint
class VideoUploadFragment : BaseFragment<FragmentVideoUploadBinding>(R.layout.fragment_video_upload),
    TranscoderListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.videoUploadButton.setOnClickListener {
            it.isEnabled = false
            binding.videoUploadButton.setBackgroundResource(com.searchai.common.R.drawable.round_viewbutton)
    ...
    override fun onResume() {
        ...
        binding.etVideoTitle.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                binding.videoUploadButton.setBackgroundResource(com.searchai.common.R.drawable.round_enable_viewbutton)
                binding.videoUploadButton.setTextColor(resources.getColor(com.searchai.common.R.color.white))
                if (binding.etVideoTitle.text?.toString().isNullOrBlank()) {
                    binding.videoUploadButton.setBackgroundResource(com.searchai.common.R.drawable.round_viewbutton)
                    binding.videoUploadButton.setTextColor(resources.getColor(com.searchai.common.R.color.cpHelpText))
                }
            }
...
//                        }
    ...
    private fun uploadVideoSuccessDialog() {
        ...
        val dialogView: View =
            inflater.inflate(com.searchai.common.R.layout.upload_video_alert_dialog, null)
        dialogView.findViewById<TextView>(com.searchai.common.R.id.textView9).text =
            resources.getString(
                com.searchai.common.R.string.msg_successful_vid,
...
//        dialogBuilder.setCancelable(true)
        ...
        val btnOkay = dialogView.findViewById<TextView>(com.searchai.common.R.id.button)

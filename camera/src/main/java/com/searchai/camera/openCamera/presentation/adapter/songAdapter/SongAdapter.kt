package com.searchai.camera.openCamera.presentation.adapter.songAdapter
...
import com.searchai.camera.openCamera.utils.diffutil.SongAdapterDiffUtilCallback
...
//                song.title.toString().substring(0, (song.title.toString().length - 4))
            ...
            if (Constant.selectSong != song.id.toString()) {
        ...
        fun onClick(
            ...
            binding.setOnAudioSelected {
                 ...
                 * Also set the (Constant.selectSong) variable as songID to indicate its visibility.*/
                    ...
                    Constant.selectSong = song.id.toString()
                }

...
import com.searchai.camera.databinding.FragmentCameraBinding
import com.searchai.camera.openCamera.data.service.AudioService
...
import com.searchai.common.models.cameraModels.CameraModes
...
class CameraFragment : BaseFragment<FragmentCameraBinding>(R.layout.fragment_camera) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.cameraViewModel = cameraViewModel.also {
            it.cameraFragment = this
        }
        // me
...
//        val file : File = File(storageDirectory , "${System.currentTimeMillis()}.mp4")
        ...
        Constant.recordVideo?.camera?.cameraControlInternal
        val startRecording = Constant.recordVideo?.startRecording(
...
//                    (activity as HomeActivity).showUploadSuccessfulDialog()
    ...
    private fun setCameraOptionText() {
        viewModel.uploadType.observe(viewLifecycleOwner) {
            when (it) {
                0 -> {

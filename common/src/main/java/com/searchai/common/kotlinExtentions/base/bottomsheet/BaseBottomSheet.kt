package com.searchai.common.kotlinExtentions.base.bottomsheet
...
abstract class BaseBottomSheet<T : ViewBinding>(
    ...
    /**
     * Makes the bottom sheet expand to full screen with custom height adjustment.
     * @param dialog The BottomSheetDialog to modify.
     * @param dp The height to subtract from the full screen height in dp.
     */
    fun setUpFullScreen(dialog: BottomSheetDialog, dp: Int) {
        val bottomSheet =
            dialog.findViewById<FrameLayout>(com.google.android.material.R.id.design_bottom_sheet)  //error here
        if (bottomSheet != null) {
            val behaviour = BottomSheetBehavior.from(bottomSheet)
            val layoutParams = bottomSheet.layoutParams

            // Get the screen height of the activity
            val activityHeight = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            // Subtract the dp value from the screen height
            layoutParams.height = activityHeight - dp.toPx().toInt()
